                  ...
                  children: [
                    ...
                    Stack(
                      children: [
                        ...
                        Center(
                          child: Text("Set Laundry PickUp", style: TextStyle(fontSize: 18.0, fontFamily: "Brand-Bold", fontWeight: FontWeight.bold),),
                        )
                      ],
                    ),
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    SizedBox(height: 2.0,),
                    Text("Folaj Laundry Office", overflow: TextOverflow.ellipsis, style: TextStyle(fontSize: 16.0),),
